...
export default class CamundaRoutes {
  ...
  static getProcessInstanceVariablesPath(processInstanceId: string) {
    return `${this.BaseURL}/engine-rest/history/variable-instance?processInstanceId=${processInstanceId}`;
  }
